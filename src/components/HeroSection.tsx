...
export function HeroSection() {
  return (
    ...
    >
      <div className="grid gap-14 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:items-center lg:gap-10">
        <div className="flex flex-col">
          <span className="section-kicker self-start">{profile.role}</span>
          <p className="mt-4 text-xs font-semibold uppercase tracking-[0.22em] text-slate-400 sm:text-sm">
            Hi, my name is
          </p>
          <h1 className="mt-2 max-w-4xl text-5xl leading-[0.95] sm:text-6xl lg:text-7xl">
            {profile.name}
          </h1>
